...
class Aplicacion:
    def __init__(self):
        self.ventana1=tk.Tk()
        self.labelframe1=ttk.LabelFrame(self.ventana1, text="Ecuación de segundo grado")
    ...
    def agregar_componentes(self):
        self.label1=ttk.Label(self.labelframe1, text="Ingrese valor a:")
        ...
        self.label2=ttk.Label(self.labelframe1, text="Ingrese valor b:")
        ...
        self.label3=ttk.Label(self.labelframe1, text="Ingrese valor c:")
